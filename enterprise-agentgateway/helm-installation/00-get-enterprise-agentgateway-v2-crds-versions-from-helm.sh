...
# export URL="us-docker.pkg.dev/solo-public/gloo-gateway/charts/enterprise-agentgateway-crds"
export URL="us-docker.pkg.dev/solo-public/enterprise-agentgateway/charts/enterprise-agentgateway-crds"
