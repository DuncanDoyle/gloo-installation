...
# export URL="us-docker.pkg.dev/developers-369321/gloo-gateway/charts/gloo-gateway-crds"

echo "TODO: Find the URL of the nigthly builds for Solo Enterprise for Agentgateway"
exit 1
