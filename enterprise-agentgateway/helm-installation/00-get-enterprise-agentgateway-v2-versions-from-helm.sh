...
# export URL="us-docker.pkg.dev/solo-public/gloo-gateway/charts/enterprise-agentgateway"
export URL="us-docker.pkg.dev/solo-public/enterprise-agentgateway/charts/enterprise-agentgateway"
